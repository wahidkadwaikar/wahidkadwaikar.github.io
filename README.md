...
- The `/field-notes/` gallery is a section of page bundles under `content/field-notes/`. Each note needs `index.md` plus `photo.jpg` (the photograph) and `note.jpg` (the stamped illustration). Front matter: `location`, `number`, `legend`, `date`.
