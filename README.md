...
- The `/field-notes/` gallery is a section of page bundles under `content/field-notes/`. Each note needs `index.md` and, when you have one, `photo.jpg`. Front matter: `location`, `number`, `legend`, `date`.
